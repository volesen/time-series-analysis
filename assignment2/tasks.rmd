...
y_pred_conf_upper <- y_pred + y_pred_quantile[2] * sqrt(y_pred_var)
y_pred_conf_lower <- y_pred + y_pred_quantile[1] * sqrt(y_pred_var)
```
...
pred_plot <- ggplot() +
  ...
  geom_line(mapping = aes(x = y_pred_seq, y = y_pred_conf_upper), alpha = 0.5, linetype = "dashed", stat = "identity") +
  geom_line(mapping = aes(x = y_pred_seq, y = y_pred_conf_lower), alpha = 0.5, linetype = "dashed", stat = "identity") +
